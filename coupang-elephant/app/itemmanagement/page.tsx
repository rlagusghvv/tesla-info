  ...
  return (
    <div className="min-h-screen bg-white text-neutral-900">
      ...
      <main className="mx-auto max-w-6xl px-4 py-10">
        ...
        <h1 className="mt-4 text-2xl font-black tracking-tight">상품 관리</h1>
        <p className="mt-3 text-sm leading-6 text-neutral-600">
          기존 메인에서 사용하던 <span className="font-bold">/itemmanagement</span> 경로 404를 막기 위해
          페이지 뼈대를 우선 복구했습니다.
        </p>

        <div className="mt-6 rounded-3xl border border-black/10 bg-neutral-50 p-6 text-sm text-neutral-700">
          TODO: 기존 관리 기능 이식 (리스트/검색/상태/업로드 히스토리 연결)
        </div>
      </main>
    </div>
  );
